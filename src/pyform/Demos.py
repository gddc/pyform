...
from src.pyform.Controls import (Button, StaticText, CheckBox, FontPicker, TextCtrl,
...
class AlternateDeclaration(Form):
    ...
    def __init__(self, parent, **kwargs):
        ...
        outer.append(
            StaticText(label='The significance of this form lies in the Source.  You\'ll need to look there ... '))
        inner = OrderedDict([])
